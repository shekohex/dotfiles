...
augroup END
  ...
  lvim.autocommands.custom_groups = {
    ...
    -- toggleterm
    {
      "TermOpen",
      "term://*",
      "lua require('user.keybindings').set_terminal_keymaps()",
    },
    ...
    { "Filetype", "rust", "nnoremap <leader>lm <Cmd>RustExpandMacro<CR>" },
    {
      "Filetype",
      "rust",
      "nnoremap <leader>lH <Cmd>RustToggleInlayHints<CR>",
    },
    ...
    -- typescript
    {
      ...
      "nnoremap gA <Cmd>TSLspImportAll<CR>",
    },
    {
      "Filetype",
      "typescript,typescriptreact",
      "nnoremap gr <Cmd>TSLspRenameFile<CR>",
    },
    {
      "Filetype",
      "typescript,typescriptreact",
